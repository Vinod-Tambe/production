...
const get_journal_trans_entries = async (startDate,endDate,acc_id,firm_id="N") => {
    ...
    const journal_trans_entries = await JournalTrans.find(query).select('jrtr_id jrtr_cr_amt jrtr_dr_amt jrtr_firm_id jrtr_user_id jrtr_crdr jrtr_acc_info jrtr_other_info');
